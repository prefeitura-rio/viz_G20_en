...
const BrazilMap2 = ({ chartType }) => {
  ...
  return <svg ref={svgRef} style={{ opacity: chartType === 'mapInfoBrazil2' ? 1 : 0, transition: "opacity 1s", position: "fixed", top: 0, width: "100vw", height: "100vh", zIndex: "3" }} />;
};

export default BrazilMap2;